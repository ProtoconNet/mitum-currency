...
var (
	RegisterModelFactHint = hint.MustNewHint("mitum-plugin-register-model-operation-fact-v0.0.1")
	RegisterModelHint     = hint.MustNewHint("mitum-plugin-register-model-operation-v0.0.1")
)
...
func NewRegisterModelFact(token []byte, sender, contract base.Address, contractCode string, currency types.CurrencyID) RegisterModelFact {
...
func (fact RegisterModelFact) ContractCode() string {
	return fact.contractCode
}
